  ...
  var ScrollSpy = (function () {
    ...
    _createClass(ScrollSpy, [{
      ...
      value: function _process() {
        ...
        for (var i = this$1._offsets.length; i--;) {
...
jQuery.fn.extend( {
	...
	closest: function( selectors, context ) {
		...
		for ( ; i < l; i++ ) {
			for ( cur = this$1[ i ]; cur && cur !== context; cur = cur.parentNode ) {
...
jQuery.event = {
	...
	handlers: function( event, handlers ) {
		...
		if ( delegateCount && cur.nodeType &&
			...
			for ( ; cur !== this$1; cur = cur.parentNode || this$1 ) {
  ...
  _createClass(Evented, [{
    ...
    value: function off(event, handler) {
      ...
      if (typeof handler === 'undefined') {
        ...
        var i = 0;
        while (i < this$1.bindings[event].length) {
          if (this$1.bindings[event][i].handler === handler) {
            this$1.bindings[event].splice(i, 1);
          } else {
            ++i;
          }
        }
    ...
    value: function trigger(event) {
      ...
      if (typeof this.bindings !== 'undefined' && this.bindings[event]) {
        ...
        for (var _len = arguments$1.length, args = Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
          args[_key - 1] = arguments$1[_key];
        }

        while (i < this$1.bindings[event].length) {
          var _bindings$event$i = this$1.bindings[event][i];
...
function addOffset() {
  ...
  for (var _len = arguments$1.length, offsets = Array(_len), _key = 0; _key < _len; _key++) {
    offsets[_key] = arguments$1[_key];
  }
  ...
  _createClass(TetherClass, [{
    ...
    value: function position() {
      ...
      for (var i = 0; i < TetherBase.modules.length; ++i) {
        ...
        var ret = _module2.position.call(this$1, {
          left: left,
          top: top,
    ...
    value: function move(pos) {
      ...
      for (var type in pos) {
        ...
        for (var key in pos[type]) {
          ...
          for (var i = 0; i < this$1.history.length; ++i) {
            var point = this$1.history[i];
